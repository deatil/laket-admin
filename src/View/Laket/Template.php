...
namespace Laket\Admin\View\Laket;

use Exception;
use Psr\SimpleCache\CacheInterface;

use Laket\Admin\View\Laket\Contract\DriverInterface;
use Laket\Admin\View\Laket\Exception\TemplateNotFoundException;
...
class Template
{
    ...
    public function __construct(array $config = [])
    {
        ...
        $class = str_contains($type, '\\') ? $type : '\\Laket\\Admin\\View\\Laket\\Driver\\' . ucwords($type);
    ...
    public function parse(string &$content): void
    {
        ...
        $tagLibs = (array) $this->config['taglib_build_in'];
     ...
     * @return array
     */
    protected function getIncludeTagLib(string &$content): array
    {
        // 搜索是否有TagLib标签
