...
<head>
    ...
    <style type="text/css">
        *{box-sizing:border-box;margin:0;padding:0;font-family:Lantinghei SC,Open Sans,Arial,Hiragino Sans GB,Microsoft YaHei,"微软雅黑",STHeiti,WenQuanYi Micro Hei,SimSun,sans-serif;-webkit-font-smoothing:antialiased}
        ...
        .system-message{border-radius: 5px;margin:20px 5%;padding:40px 20px;background:#fff;box-shadow:1px 1px 1px hsla(0,0%,39%,.1);text-align:center}
...
<div class="system-message {$codeText}">
    ...
    {/if}
    <p class="clearfix">
        <a href="javascript:history.back();" class="btn btn-grey">返回上页</a>
        {if $url}
